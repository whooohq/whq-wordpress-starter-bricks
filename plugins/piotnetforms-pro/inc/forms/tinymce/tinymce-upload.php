<?php
   ...
   ******************************************************/
  $accepted_origins = [ get_bloginfo( 'url' ) ];
  ...
  */
  ...
  // Verify extension
  if ( !in_array( strtolower( pathinfo( $temp['name'], PATHINFO_EXTENSION ) ), [ 'jpeg','gif', 'jpg', 'png' ] ) ) {
  ...
  echo json_encode( [ 'location' => $filetowrite, 'id' => $image_id ] );
  //} else {
