...
use psetasign\Fpdi\PdfParser\Filter\Ascii85;
use psetasign\Fpdi\PdfParser\Filter\AsciiHex;
use psetasign\Fpdi\PdfParser\Filter\FilterException;
use psetasign\Fpdi\PdfParser\Filter\Flate;
use psetasign\Fpdi\PdfParser\Filter\Lzw;
...
use psetasign\FpdiPdfParser\PdfParser\Filter\Predictor;
                        ...
                        if ($predictor->value !== 1) {
                            if (!\class_exists(Predictor::class)) {
                                throw new PdfParserException(
                                    ...
                                    'commercial "FPDI PDF-Parser" add-on (see https://www.psetasign.com/fpdi-pdf-' .
                                    'parser).',
