...
namespace psetasign\Fpdi;

use psetasign\Fpdi\PdfParser\CrossReference\CrossReferenceException;
use psetasign\Fpdi\PdfParser\Filter\FilterException;
use psetasign\Fpdi\PdfParser\PdfParser;
use psetasign\Fpdi\PdfParser\PdfParserException;
use psetasign\Fpdi\PdfParser\StreamReader;
use psetasign\Fpdi\PdfParser\Type\PdfArray;
use psetasign\Fpdi\PdfParser\Type\PdfBoolean;
use psetasign\Fpdi\PdfParser\Type\PdfDictionary;
use psetasign\Fpdi\PdfParser\Type\PdfHexString;
use psetasign\Fpdi\PdfParser\Type\PdfIndirectObject;
use psetasign\Fpdi\PdfParser\Type\PdfIndirectObjectReference;
use psetasign\Fpdi\PdfParser\Type\PdfName;
use psetasign\Fpdi\PdfParser\Type\PdfNull;
use psetasign\Fpdi\PdfParser\Type\PdfNumeric;
use psetasign\Fpdi\PdfParser\Type\PdfStream;
use psetasign\Fpdi\PdfParser\Type\PdfString;
use psetasign\Fpdi\PdfParser\Type\PdfToken;
use psetasign\Fpdi\PdfParser\Type\PdfType;
use psetasign\Fpdi\PdfParser\Type\PdfTypeException;
use psetasign\Fpdi\PdfReader\PageBoundaries;
use psetasign\Fpdi\PdfReader\PdfReader;
use psetasign\Fpdi\PdfReader\PdfReaderException;
use /* This namespace/class is used by the commercial FPDI PDF-Parser add-on. */
    /** @noinspection PhpUndefinedClassInspection */
    /** @noinspection PhpUndefinedNamespaceInspection */
    psetasign\FpdiPdfParser\PdfParser\PdfParser as FpdiPdfParser;
...
trait FpdiTrait
{
    ...
    public function setSourceFile($file)
    {
        ...
        //var_dump($this->currentReaderId); die('1221');
