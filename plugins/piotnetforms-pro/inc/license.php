...
class Piotnetforms_License_Service {
	const PRO_VERSION = PIOTNETFORMS_PRO_VERSION;
	const PLUGIN_BASENAME = PIOTNETFORMS_PLUGIN_BASENAME;
	const LICENSE_API_DOMAIN = 'https://api.piotnet.com';
	const FREE_VERSION_NAME = 'PIOTNETFORMS_VERSION';
	const PREFIX_OPTION_KEY = 'piotnetforms_';
	const PLUGIN_SLUG = 'piotnetforms-pro';
	const HOMEPAGE_URL = 'https://piotnetforms.com';
	const LICENSE_DATA_V1_OPTION_KEY = 'piotnetforms_license';
