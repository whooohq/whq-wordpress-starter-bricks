...
abstract class Scripts_Field extends Textarea_Field
{
    ...
    {
        $is_valid_datastore = $this->get_datastore() instanceof \FuerteWpDep\Carbon_Fields\Datastore\Theme_Options_Datastore || $this->get_datastore() instanceof \FuerteWpDep\Carbon_Fields\Datastore\Network_Datastore;
