...
use FuerteWpDep\WP_Term_Query;
use FuerteWpDep\WP_User_Query;
use FuerteWpDep\WP_Comment_Query;
/**
...
class Association_Field extends Field
{
    ...
    {
        $this->wp_toolset = \FuerteWpDep\Carbon_Fields\Carbon_Fields::resolve('wp_toolset');
    ...
    protected function value_string_to_property_array($value_string)
    {
        ...
        $property_array = array(Value_Set::VALUE_PROPERTY => $value_string, 'type' => $type, 'subtype' => $subtype, 'id' => \intval($id));
    ...
    {
        return array('id' => \intval($data->ID), 'title' => $this->get_title_by_type($data->ID, $data->type, $data->subtype), 'thumbnail' => '', 'type' => $data->type, 'subtype' => $data->subtype, 'label' => $this->get_item_label($data->ID, $data->type, $data->subtype), 'is_trashed' => \false, 'edit_link' => $this->get_object_edit_link(\get_object_vars($data), $data->ID));
    }
    /**
