...
namespace FuerteWpDep\Carbon_Fields\Container\Fulfillable;

use FuerteWpDep\Carbon_Fields\Container\Condition\Factory;
use FuerteWpDep\Carbon_Fields\Container\Fulfillable\Translator\Array_Translator;
...
class Fulfillable_Collection implements Fulfillable
{
    ...
    {
        return \FuerteWpDep\Carbon_Fields\Carbon_Fields::resolve('container_condition_fulfillable_collection');
    }
    /**
